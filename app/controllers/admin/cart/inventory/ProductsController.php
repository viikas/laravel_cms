...
class ProductsController extends \BaseController {
    ...
    public function index() {
        return \View::make('admin.cart.inventory.products.index')->with('collection', $this->repo->getProducts());
    }
    ...
    public function show($id) {
        ...
        return \View::make('admin.cart.inventory.products.show')->with('item', $item);
    }

    public function create() {
        $unitsList = $this->repo->getUnitsList();
        $units = \Helper::SetDefaultSelect($unitsList, '', '--choose unit--');
        $catsList=$this->repo->getCategoriesList();
        $cats=\Helper::SetDefaultSelect($catsList, '', '--choose category--');
        return \View::make('admin.cart.inventory.products.create')->with('cats', $cats)->with('units', $units);
    }
    ...
    public function edit($id) {
        ...
        return \View::make('admin.cart.inventory.products.edit')->with('item', $item)->with('cats', $this->repo->getCategoriesList())->with('units', $this->repo->getUnitsList());
    }
