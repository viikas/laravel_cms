...
<h2>Edit Photo : {{$item->name}}</h2>

@include('admin._partials.notifications')

{{ Form::open(array('method'=>'put','files'=>'true','route' => array('admin.cart.inventory.products.photos.update',$item->id,$photo->id))) }}
<div class="control-group">
    {{Form::label('photo_image','Photo')}}
    <div class="fileupload fileupload-new" data-provides="fileupload">
        <div class="fileupload-preview thumbnail" style="width: 200px; height: 150px;">
            @if($photo->photo)
            <a href="{{$photo->photo;}}"><img src="{{Image::resize($photo->photo, 200, 150); }}" alt=""></a>            
            @else
...
<div class="control-group">
    ...
    {{Form::textarea('caption',$photo->caption,array('style'=>'height:150px'))}}
</div>
