...
<h2>Edit limousine</h2>

@include('admin._partials.notifications')

{{ Form::model($limo, array('method' => 'put', 'route' => array('admin.limousines.update', $limo->id),'files'=>'true')) }}
...
<div class="control-group">
    ...
    <div class="fileupload fileupload-new" data-provides="fileupload">
        <div class="fileupload-preview thumbnail" style="width: 200px; height: 150px;">
            @if ($limo->photo)
                <a href="<?php echo $limo->photo; ?>"><img src="<?php echo Image::resize($limo->photo, 200, 150); ?>" alt=""></a>
            @else
