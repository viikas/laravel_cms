                    ...
                    <div id="main">
                        <table width="1024px">
                            <tr>
                                ...
                                <td width="768" valign="top"><div id="right" style="width:100%;">                         
                                        <link rel="stylesheet" type="text/css" href="{{asset('site/assets/css/jquery-ui.css')}}"/>
                                        <script type="text/javascript" src="http://code.jquery.com/jquery-1.11.1.min.js"></script>
                                        <script type="text/javascript" src="{{asset('site/assets/js/jquery-ui-1.10.4.custom.min.js')}}"></script>
                                        <style>.ui-datepicker {
