...
<html lang="en-US">
    ...
    <body>
        ...
        <p>Thanks for placing a booking order at limousinesydneyaustralia.com. Your booking reference is sent in this email. </p>
        <div>You order is <b>UNDER REVIEW</b> by one of our sales representative.</div>
        <div style="margin-top: 8px;"><b>YOU WILL GET VOUCHER EMAIL ONCE OUR SALES REPRESENTATIVE CONFIRMS YOUR ORDER. </b></div>
        <hr/>
