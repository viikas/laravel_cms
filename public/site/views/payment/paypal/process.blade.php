...
<div class="row">
    <div class="large-12 columns"><h2>Processing Payment</h2></div>

    <div id="content-simple" style="font-size: 14px;font-family: Arial, Helvetica, sans-serif;text-align: left;"">
        {{Form::open(array('method'=>'post','route'=>'site.cart.paypal_redirect','id'=>'form1'))}}
        <div style="margin:20px;font-weight: bold;font-size: 14px;">
            <div style="color:#468847;">We are processing for the payment. Please keep patience..
